...
public class FakeRecordWriter extends HadoopizerRecordWriter {

    private DataOutputStream out;
    private Path headerTempFile;
    private Configuration conf;

    public FakeRecordWriter(DataOutputStream out, TaskAttemptContext context, Path headerTempFile) {
